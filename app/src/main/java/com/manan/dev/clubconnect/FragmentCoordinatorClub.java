...
public class FragmentCoordinatorClub extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_coordinator_club, container, false);
        userIdArrayList = new ArrayList<>();
        userIdList = new HashMap<>();
        allUsers = new HashMap<>();
        String clubName = this.getActivity().getIntent().getStringExtra("name");

        RecyclerView adminMemberRecyclerView = (RecyclerView) view.findViewById(R.id.coordinator_recycler_view);
